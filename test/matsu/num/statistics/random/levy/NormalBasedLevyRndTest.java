...
public class NormalBasedLevyRndTest {
    ...
    public static class Levy乱数のテスト {
        ...
        public void before() {
            framework = FloatingRandomGeneratorTestingFramework
                    .instanceOf(new TestedLevy(Random.threadSeparatedRandom()));
        }
        ...
        private static final class TestedLevy implements TestedFloatingRandomGenerator {
            ...
            public TestedLevy(Random random) {
                this.random = Objects.requireNonNull(random);
                this.levyRnd = new NormalBasedLevyRnd();
            }
    ...
    public static class toString表示 {
        ...
        public void test_toString() {
            ...
            System.out.println(new NormalBasedLevyRnd());
            System.out.println();
        }
    }
