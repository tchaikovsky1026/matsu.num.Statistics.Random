...
public class GammaBasedBetaRndFactoryTest {

    public static final Class<?> TEST_CLASS = GammaBasedBetaRndFactory.class;
    private static final BetaRnd.Factory FACTORY =
            new GammaBasedBetaRndFactory(RandomGeneratorFactoryProvider.byDefaultLib());
    ...
    public static class ベータ乱数のテスト {
        ...
        public void before() {
            framework =
                    FloatingRandomGeneratorTestingFramework.instanceOf(new TestedBeta(BaseRandom.threadSeparatedRandom()));
        }
