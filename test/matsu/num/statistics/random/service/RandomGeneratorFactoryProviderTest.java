...
import static matsu.num.statistics.random.service.RandomGeneratorType.*;
...
public class RandomGeneratorFactoryProviderTest {

    public static final Class<?> TEST_CLASS = RandomGeneratorFactoryProvider.class;
    ...
    public static class 戻り値型のテスト {
        ...
        public static void beforeAll_detaを準備する() {
            ...
            MAP.put(CAUTHY_RND, CauthyRnd.Factory.class);
    ...
    public static class ファクトリ生成のテスト {
        ...
        public void test_ファクトリが生成できることを検証する() throws InterruptedException, ExecutionException {
            ...
            Future<?> submit = service.submit(() -> RandomGeneratorType.values().forEach(provider::get));
            service.shutdown();
            try {
